...
function jdAdNShow(jdAdId, jdAdWidth,jdAdHeight,ratio,jdAdFlag,mobileType) {
    ...
    var adflag = jdAdFlag||0;
    doc.open();
    doc.write('<script>var width="' + jdAdWidth + '";var height="' + jdAdHeight + '";var id="' + jdAdId + '";var adflag="' + adflag + '";var mobileType="'+(mobileType!=null?mobileType:1)+'";</script>\
        <html style="overflow:hidden;"><body style="margin:0;overflow:hidden;" onload="\
　　var d = document;\
    var script = d.createElement(\'script\');\
    script.src = \'http://static.360buyimg.com\/jzt\/temp\/js\/jztshow.js\';\
